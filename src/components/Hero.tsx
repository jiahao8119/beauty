  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-50 via-white to-beige-50 min-h-screen flex items-center">
      ...
      <div className="fixed top-8 left-1/2 -translate-x-1/2 z-50">
        <div className="bg-white/90 border-2 border-gold text-gold font-extrabold px-6 py-2 rounded-full shadow-2xl flex items-center gap-3 text-2xl animate-pulse-gold">
