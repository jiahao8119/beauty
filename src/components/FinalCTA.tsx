...
const FinalCTA = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-primary-600 via-primary-500 to-primary-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              ...
              <h3 className="text-xl font-semibold mb-2">Daily Skincare Routine</h3>
              <p className="text-sm opacity-80">Step-by-step morning and evening routines</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              <Download className="w-12 h-12 text-gold mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Ingredient Guide</h3>
              <p className="text-sm opacity-80">What to look for and what to avoid</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
              <Gift className="w-12 h-12 text-gold mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Exclusive Tips</h3>
              <p className="text-sm opacity-80">Professional secrets from dermatologists</p>
            </div>
          </div>
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-3xl p-8 max-w-2xl mx-auto mb-12">
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                <h3 className="text-2xl font-bold mb-4">Download Your Free Guide Now</h3>
              ...
              <div className="text-center animate-scale-in">
                ...
                <p className="text-lg">Check your email for the download link to your free Skin Glow Guide!</p>
              </div>
            )}
          </div>
